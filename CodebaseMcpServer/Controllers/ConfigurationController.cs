...
public class ConfigurationController : ControllerBase
{
    ...
    public async Task<ActionResult<ValidationResult>> ValidateWatchConfiguration([FromBody] WatchConfigurationDto config)
    {
        try
        {
            var result = _validationService.ValidateWatchConfiguration(config);
            return Ok(result);
        }
        catch (Exception ex)
        {
    ...
    public async Task<ActionResult<ValidationResult>> ValidateMetadata([FromBody] MetadataDto metadata)
    {
        try
        {
            var result = _validationService.ValidateMetadata(metadata);
            return Ok(result);
        }
        catch (Exception ex)
        {
    ...
    public async Task<ActionResult<ValidationResult>> ValidateJsonString([FromBody] ValidateJsonRequest request)
    {
        try
        {
            var result = _validationService.ValidateJsonString(request.JsonString, request.ConfigType);
            return Ok(result);
        }
        catch (Exception ex)
        {
    ...
    public async Task<ActionResult<CleanupResult>> CleanupConfiguration([FromBody] WatchConfigurationDto config)
    {
        try
        {
            var result = _validationService.CleanupConfiguration(config);
            return Ok(result);
        }
        catch (Exception ex)
        {
    ...
    public async Task<ActionResult<List<ConfigurationSuggestion>>> GetConfigurationSuggestions([FromBody] GetSuggestionsRequest request)
    {
        try
        {
            var suggestions = _validationService.GetConfigurationSuggestions(request.Config, request.ProjectType);
    ...
    public async Task<ActionResult<ConfigurationDiff>> CompareConfigurations([FromBody] CompareConfigurationsRequest request)
    {
        try
        {
            var diff = _managementService.CompareConfigurations(request.Config1, request.Config2, request.Label1, request.Label2);
            return Ok(diff);
        }
        catch (Exception ex)
        {
