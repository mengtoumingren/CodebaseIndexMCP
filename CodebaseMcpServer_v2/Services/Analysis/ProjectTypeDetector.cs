...
public class ProjectTypeDetector
{
    ...
    public async Task<ProjectTypeDetectionResult> DetectProjectTypeAsync(string codebasePath)
    {
        try
        {
            ...
            // 检测各种项目类型
            detectionResults.Add(DetectCSharpProjectAsync(codebasePath));
            detectionResults.Add(DetectTypeScriptProjectAsync(codebasePath));
            detectionResults.Add(DetectJavaScriptProjectAsync(codebasePath));
            detectionResults.Add(DetectPythonProjectAsync(codebasePath));
            detectionResults.Add(DetectJavaProjectAsync(codebasePath));
            detectionResults.Add(DetectCppProjectAsync(codebasePath));
            detectionResults.Add(DetectGoProjectAsync(codebasePath));
            detectionResults.Add(DetectRustProjectAsync(codebasePath));
    ...
    // 具体检测方法
    private (ProjectType, double, List<string>) DetectCSharpProjectAsync(string path)
    {
    ...
    private (ProjectType, double, List<string>) DetectTypeScriptProjectAsync(string path)
    {
        var evidence = new List<string>();
        double score = 0;
    ...
    private (ProjectType, double, List<string>) DetectJavaScriptProjectAsync(string path)
    {
        var evidence = new List<string>();
        double score = 0;
    ...
    private (ProjectType, double, List<string>) DetectPythonProjectAsync(string path)
    {
        var evidence = new List<string>();
        double score = 0;
    ...
    private (ProjectType, double, List<string>) DetectJavaProjectAsync(string path)
    {
        var evidence = new List<string>();
        double score = 0;
    ...
    private (ProjectType, double, List<string>) DetectCppProjectAsync(string path)
    {
        var evidence = new List<string>();
        double score = 0;
    ...
    private (ProjectType, double, List<string>) DetectGoProjectAsync(string path)
    {
        var evidence = new List<string>();
        double score = 0;
    ...
    private (ProjectType, double, List<string>) DetectRustProjectAsync(string path)
    {
        var evidence = new List<string>();
        double score = 0;
