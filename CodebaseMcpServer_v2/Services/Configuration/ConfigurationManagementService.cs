...
public class ConfigurationManagementService : IConfigurationManagementService
{
    ...
    public ConfigurationDiff CompareConfigurations(WatchConfigurationDto config1, WatchConfigurationDto config2, string? label1 = null, string? label2 = null)
    {
        ...
        // No awaitable operations here, so no Task.Run needed.
        // The warning was likely due to the method being async Task<ActionResult<ConfigurationDiff>> in the controller,
        // but this service method is synchronous. The controller method was already fixed.
